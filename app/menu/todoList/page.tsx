...
import { todayClean, transDate } from "../../../util/commonFunc"
        ...
        <div className="flex">
            ...
            <div className="w-[85%] text-left p-5 place-items-center">
                ...
                <div className="w-[50%] mt-20 px-10 py-5 rounded-xl outline-1 outline-gray-400 bg-white">
                    <button type="button" className="mb-5 bg-gray-300 px-2 py-0.5 rounded-xl" disabled={todoDate != todayClean() ? true : false}
                        onClick={(e)=>{
                            fetch('/api/todoList/detail?date='+todoDate,{
                                method: 'POST'
                            }).then((r)=>r.json())
